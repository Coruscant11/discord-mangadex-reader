...
public class CommandsRegister {
    ...
    public static void deleteGlobalsCommands(DiscordApi api) {
        ...
        for (SlashCommand command : commands) {
            System.out.println(command.getName() + " deleted.");
    ...
    public static SlashCommandBuilder buildSearchMangaCommand() {
        return SlashCommand.with("search", "Search a manga on Mangadex",
                Arrays.asList(
    ...
    public static SlashCommandBuilder buildSetPageCommand() {
        return SlashCommand.with("page", "Set the current page",
                Arrays.asList(
    ...
    public static SlashCommandBuilder buildSetVolumeCommand() {
        return SlashCommand.with("volume", "Set the current volume",
                Arrays.asList(
